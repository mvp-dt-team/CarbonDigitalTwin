...
def calculate_parameters(resolution_pixels, pixel_size_um, height_m, lens_focal_length_mm):
    """
...
def main():
    ...
    for focal_length in lens_focal_lengths_mm:
        coverage, resolution = calculate_parameters(resolution_pixels, pixel_size_um, height_m, focal_length)
